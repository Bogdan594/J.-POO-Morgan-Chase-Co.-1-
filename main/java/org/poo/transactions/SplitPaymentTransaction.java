...
public class SplitPaymentTransaction extends Transaction {
    ...
    public SplitPaymentTransaction(final int timestamp, final String currency, final double total,
        ...
        // dar chiar nu am gasit alta solutie eficienta
        this.description = "Split payment of " + df.format(total) + " " + currency;
    }
}
